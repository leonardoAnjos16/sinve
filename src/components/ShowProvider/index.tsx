...
export const ShowProvider: React.FC<ShowProviderProps> = ({ width, onClick }) => (
  <Container width={width}>
    ...
    <ContentContainer>
      <InputSinve width="20%" title="CNPJ" />
      <InputSinve width="35%" title="Nome Fantasia" />
      <InputSinve width="15%" title="Telefone" />
      <InputSinve width="30%" title="Prazo de entrega" isSelectDate />
    </ContentContainer>
